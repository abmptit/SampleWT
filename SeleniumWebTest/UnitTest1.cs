namespace SeleniumWebTest
{
    ...
    public class UnitTest1
    {
        ...
        private readonly string _iframeWithComponents = @"D:/MyGitHub/SampleWT/SeleniumWebTest/TestedSite/componentsTestIntoIFrame.html";

        [Test]
        public void Selenium_ClickOnButtonIntoIFrame_WithChangingPadding()
        {
            var webDriver = WebDriverHelper.CreateSession();
